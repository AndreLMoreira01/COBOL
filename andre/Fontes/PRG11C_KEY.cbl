       ...
       01  CAMPOS-W.
           ...
           03  CAMPOS-TELA-W.
               ...
               05 W-ID-INI                PIC 9(06).
	       05 W-ID-FIN                PIC 9(06).
               05 W-AUX-ID                PIC 9(06). 
	       ...
	       05 W-EMPRESA-ANTERIOR      PIC 9(3) VALUE 0.
	       05 W-CENTCUS-ANTERIOR      PIC 9(06) VALUE 0.
	       ...
	       05 W-TOTAL-EMPRESA         PIC 9(11)V99 VALUE 0.
               ...
               05 W-CAB-EMPRESA.
                  07 W-NOME-EMPRESA        PIC  X(9).
                  07 W-COD-EMPRESA         PIC  ZZ9B.

               05 W-CAB-CENTCUS.
                  07 W-NOME-CENTCUS        PIC  X(21).
                  07 W-COD-CENTCUS         PIC  99.99.99B.
      ...
      -              'IO-----'.
       ...
       01  TELA-PRINCIPAL.
           ...
           03 LABEL       LINE 04 COL 32
                          TITLE "a"
                          ID 10
                          TRANSPARENT.
              
        
           03 ENTRY-FIELD USING W-ID-INI
                          LINE 04
                          COL 23
                          3-D
                          BOXED
       ...
       TRATA-EXCEPTION-TELA-PRINCIPAL.
		  ...
		  |*testa range da empresa

		  IF W-ID-INI <= 0
		      MOVE 1 TO W-ID-INI
		  ELSE
                      MOVE W-ID-INI TO W-EMPRESA-ANTERIOR
                  END-IF
		  
		  IF W-ID-FIN <= 0
		      MOVE 999999 TO W-ID-FIN
		  END-IF

                  IF W-ID-FIN < W-ID-INI
                     INITIALIZE CA-MESSAGE-LINK
                     MOVE 'Range de empresa inválido.' TO CA-MESSAGE-1
                     PERFORM MOSTRA-MSG-ERRO
                     EXIT PARAGRAPH
                  END-IF

                  |começa a executar a impressão
       ...
       INPUTPROCE.
           ...
           PERFORM UNTIL NOT VALID-CADFUN
              ...
              IF (W-DATADMI-I >= W-DATAINI-I AND <= W-DATAFIN-I)	    
                IF (DFUN-EMPRESA-1 >= W-ID-INI AND <= W-ID-FIN) 
       ...
       OUTPUTPROC.
           ...
           PERFORM UNTIL 1 = 2
              RETURN SORTER AT END
                            EXIT PERFORM
              END-RETURN
	      IF W-EMPRESA-ANTERIOR <> SORT-EMPRESA-1 AND
	         W-CENTCUS-ANTERIOR <> 0
			MOVE 800 TO W-CONTLIN
			SET FIM-EMPRESA TO TRUE
			| IMPRIME TOTAL DO CENTRO DE CUSTOS
		        MOVE SPACES TO W-LINHA-DETALHE
		        MOVE '           *** TOTAL DO CENTRO DE CUSTO: ' 
		              TO W-NOMEFUN-DET
		        MOVE W-CENTCUS-ANTERIOR TO W-CENTCUS-DET
		        MOVE W-TOTAL-CENTCUS TO W-SALARIO-DET
                        ADD W-TOTAL-CENTCUS TO W-TOTAL-EMPRESA
			INITIALIZE W-TOTAL-CENTCUS
		        WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 1
                        ADD 1 TO W-CONTLIN
                        MOVE SPACES TO W-LINHA-DETALHE
                        WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 1
                        ADD 1 TO W-CONTLIN
			MOVE 0 TO W-CENTCUS-ANTERIOR 
	      END-IF
		 ...
		 IF W-CENTCUS-ANTERIOR = 0
		 | IMPRIME APENAS CABEÇALHO DO CENTRO DE CUSTOS
		
		    MOVE SPACES TO W-CAB-CENTCUS
		    MOVE '    CENTRO DE CUSTO: ' TO W-NOME-CENTCUS
		    MOVE SORT-CENTCUS-1 TO W-COD-CENTCUS
		    WRITE PRINTF-R FROM W-CAB-CENTCUS AFTER 1
		    ADD 1 TO W-CONTLIN
		 ELSE
		 | IMPRIME TOTAL DO CENTRO DE CUSTOS
		     MOVE SPACES TO W-LINHA-DETALHE
		    ...
		    WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 1
                    ...
                    WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 1
                    ADD 1 TO W-CONTLIN
		  | IMPRIME CABEÇALHO DO CENTRO DE CUSTOS
		     MOVE SPACES TO W-LINHA-DETALHE
		     WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 1
		    ADD 1 TO W-CONTLIN
		    MOVE SPACES TO W-CAB-CENTCUS
       ...
       IMPRIME-CABECALHO.
           ...
           MOVE SPACES TO PRINTF-R
           WRITE PRINTF-R AFTER 1
           MOVE SPACES TO W-CAB-EMPRESA
           MOVE 'EMPRESA: ' TO W-NOME-EMPRESA
           MOVE SORT-EMPRESA-1 TO W-COD-EMPRESA
           WRITE PRINTF-R FROM W-CAB-EMPRESA AFTER 1
           ADD 2 TO W-CONTLIN.
           
           COPY "ERRO.CPY".
           COPY "MSG-ERRO.CPY".
           COPY "PRG-INICIALIZA.CPY".
           COPY "DATASP.CPY".
