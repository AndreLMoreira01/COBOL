	   ...
	   03  SORT-NOMEMPR-1             PIC  X(10).
           03  SORT-CODEMPC-1             PIC  9(06).
	   ...
	   03  STAT-CADFUN                PIC  X(02).
		  ...
		  07 W-NOMEMPR-DET        PIC  X(010)B.
                  07 W-CODEMPC-DET        PIC  ZZZ.ZZ9B.
		  ...
		  07 W-NOMEFUN-DET        PIC  X(40)B.
               ...
               05 W-CAB-2.
                  07 PIC X(132) VALUE 'EMPRESSA -------------------FUNCI
      -		     'ONARIO--------------------- C. CUSTO -ADMISSAO- --   
      -		     '---SALARIO-----'.
       ...
       TRATA-EXCEPTION-TELA-PRINCIPAL.
           EVALUATE TECLA-ESCAPE
             WHEN EXCEPTION-IMPRIMIR
                  ...
                  START CADEMP KEY >= DEMP-RECORDK-1
                  IF VALID-CADEMP
        ...
        INPUTPROCE.
	      ...
	      MOVE DFUN-EMPRESA-1 TO DEMP-CODEMP-1
		 ...
		 MOVE DEMP-NOMEEMP-1 TO SORT-NOMEMPR-1
       ...
       OUTPUTPROC.
	      ...
	      MOVE SORT-NOMEMPR-1 TO W-NOMEMPR-DET
              ...
              ADD 1 TO W-CONTLIN
              ADD SORT-SALARIO-1 TO W-TOT-SALARIO
           END-PERFORM.
