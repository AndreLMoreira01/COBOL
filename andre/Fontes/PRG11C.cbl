       ...
       01  CAMPOS-W.
           ...
           03  CAMPOS-TELA-W.
               ...
               05 W-EMPRESA-ANT           PIC  9(03) VALUE 0.
               05 W-CENTCUS-ANT           PIC  9(06) VALUE 0.
               05 W-TOT-SALARIO-CCUSTO    PIC  9(11)V99 VALUE 0.
               05 W-TOT-SALARIO-EMPRESA   PIC  9(11)V99 VALUE 0.
               05 W-TOT-SALARIO-GERAL     PIC  9(11)V99 VALUE 0.
               ...
               05 W-CAB-2.
                  07 FILLER               PIC  X(10) VALUE 'EMPRESA : '.
                  07 WCAB-EMPRESA-2       PIC  999B.
               
               05 W-CAB-3.   
                  07 FILLER               PIC  X(10) VALUE 'C.CUSTO : '.
                  07 WCAB-CENTCUS-2       PIC  99.99.99.
      ...
      -              'IO-----'.
       ...
       INICIO.
           ...
           DISPLAY INITIAL GRAPHICAL WINDOW
                           ...
                           COLOR 257
                           TITLE "Relatório Com Cabeçalho, Quebra e Tota
      -                          "lização"
                           NO SCROLL
                           SYSTEM MENU
                           AUTO-RESIZE
           ...
           EVALUATE TECLA-ESCAPE
             WHEN EXCEPTION-IMPRIMIR
                  ...
                  INITIALIZE W-NROPAGI
                             W-EMPRESA-ANT
                             W-CENTCUS-ANT
                             W-TOT-SALARIO-CCUSTO
                             W-TOT-SALARIO-EMPRESA
                             W-TOT-SALARIO-GERAL
       ...
       OUTPUTPROC.
           PERFORM UNTIL 1 = 2
              ...
              IF SORT-EMPRESA-1 <> W-EMPRESA-ANT
                 IF W-EMPRESA-ANT <> 0
                    PERFORM TOTALIZA-EMPRESA
                 END-IF
                 MOVE SORT-EMPRESA-1 TO W-EMPRESA-ANT
                                        WCAB-EMPRESA-2
                 MOVE 800 TO W-CONTLIN
                 INITIALIZE W-CENTCUS-ANT
              END-IF

              PERFORM TESTA-QUEBRA-PAGINA
 
              IF SORT-CENTCUS-1 <> W-CENTCUS-ANT
                 IF W-CENTCUS-ANT <> 0
                    PERFORM TOTALIZA-CCUSTO
                 END-IF
                 MOVE SORT-CENTCUS-1 TO W-CENTCUS-ANT
                                        WCAB-CENTCUS-2
                 WRITE PRINTF-R FROM W-CAB-3 AFTER 2
      ...
      *          MOVE 800 TO W-CONTLIN
              ...
              ADD 1 TO W-CONTLIN
              ADD SORT-SALARIO-1 TO W-TOT-SALARIO-CCUSTO
           END-PERFORM.
       ...
       TESTA-QUEBRA-PAGINA.
           IF W-CONTLIN > 64
              ...
              WRITE PRINTF-R FROM W-CAB-4 AFTER 2
**************WRITE PRINTF-R FROM W-CAB-3 AFTER 2 
              MOVE SPACES TO PRINTF-R
              WRITE PRINTF-R AFTER 1
       ...
       TOTALIZA-CCUSTO.
           ...
           MOVE '*** TOTAL DO CENTRO DE CUSTO' TO W-NOMEFUN-DET
           MOVE W-TOT-SALARIO-CCUSTO TO W-SALARIO-DET
           WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 2
           ADD 2 TO W-CONTLIN.

           ADD W-TOT-SALARIO-CCUSTO TO W-TOT-SALARIO-EMPRESA.
           INITIALIZE W-TOT-SALARIO-CCUSTO.
       ...
       TOTALIZA-EMPRESA.
           ...
           MOVE SPACES TO W-LINHA-DETALHE
           MOVE '*** TOTAL DA EMPRESA' TO W-NOMEFUN-DET
           MOVE W-TOT-SALARIO-EMPRESA TO W-SALARIO-DET
           WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 2
           ADD 2 TO W-CONTLIN.

           ADD W-TOT-SALARIO-EMPRESA TO W-TOT-SALARIO-GERAL.
           INITIALIZE W-TOT-SALARIO-EMPRESA.
       ...
       TOTALIZA-GERAL.
           ...
           MOVE W-TOT-SALARIO-GERAL TO W-SALARIO-DET
           WRITE PRINTF-R FROM W-LINHA-DETALHE AFTER 2.
