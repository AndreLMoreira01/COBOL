       ...
       ROTINA-GRAVAR.
           ...
           MOVE W-PRODUTO-EDIT TO TDES-CODIGO-2
           READ TABDESC
           IF NOT VALID-TABDESC
              INITIALIZE CA-MESSAGE-LINK
              STRING 'Produto ' TDES-CODIGO-2 ' não cadastrado.'
                   DELIMITED BY SIZE 
                   INTO CA-MESSAGE-1
	   ...
	   INITIALIZE TDES-REGISTR-2
           MOVE W-CLIENTE-EDIT TO TDES-CODIGO-2
           READ TABCLI
           IF NOT VALID-TABCLI
              INITIALIZE CA-MESSAGE-LINK
              STRING 'Cliente ' TABCLI-CODIGO-2 ' não cadastrado.'
                   DELIMITED BY SIZE 
                   INTO CA-MESSAGE-1
              PERFORM MOSTRA-MSG-ERRO
              MOVE 4 TO W-ACCEPT-CONTROL
	   ...
	   INITIALIZE TDES-REGISTR-2
           MOVE W-Ven-EDIT TO TDES-CODIGO-2
           READ TABPR
           IF NOT VALID-TABPR
              INITIALIZE CA-MESSAGE-LINK
              STRING 'Cliente ' TABPR-CODIGO-2 ' não cadastrado.'
                   DELIMITED BY SIZE 
                   INTO CA-MESSAGE-1
              PERFORM MOSTRA-MSG-ERRO
              MOVE 4 TO W-ACCEPT-CONTROL
