       ...
       01  TDES-REGISTR-1.
           03  TDES-RECORDK-1.
               05 TDES-CODIGO-1          PIC  9(03).
           03  TDES-NOME-1             PIC  X(60).
           03  TDES-TVE-1             PIC  9(09)V99.
       ...
       01  CAMPOS-W.
           03  STAT-TAV                PIC  X(02).
               88 VALID-TAV            VALUE '00' THRU '09'.

           03  CAMPOS-TELA-W.
               05 W-CODIGO-EDIT          PIC  ZZ9.
               05 W-NOME-EDIT          PIC  x(60).
               05 W-TVE-EDIT          PIC  ZZ9,99.

               05 W-CODIGO          PIC  9(03).
       ...
       01  TELA-PRINCIPAL.
           ...
           03 ENTRY-FIELD USING W-TVE-EDIT
                          LINE 09
                          COL 30
                          3-D
                          BOXED
       ...
       EVENTO-BTN-LER-ARQUIVO.
           ...
           IF STAT-TAV = '23'
              INITIALIZE CA-MESSAGE-LINK
              MOVE 'Tabela não cadastrado.' TO CA-MESSAGE-1
              PERFORM MOSTRA-MSG-MENSAGEM
           ELSE
              IF NOT VALID-TAV
                 PERFORM ERRO-ARQUIVO.
