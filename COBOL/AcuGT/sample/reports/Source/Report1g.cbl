      *{Bench}prg-comment
      * Report1g.cbl
      * Report1g.cbl is generated from C:\Acucorp\Acucbl720\AcuGT\sample\reports\Report1g.Psf
      *{Bench}end
      ...
      *{Bench}prgid
       ...
       REMARKS. 
           Report1g is an N-Top Report.
           
           N-Top reports display horizontally, instead of vertically.
           Note- The N-Top effect is a Display-Oriented effect, that can be 
           seen when the Report is opened in a Browser.  The Print and 
           Print Preview functions will be limited to printing/showing the first 
           page of the N-Top Report.  When creating an N-Top report, user
           should use the Print-TOFILE paragraph to write the report to file, 
           and then use other means to display the report.
           
           Note that since the N-Top Report is not designed for Printing, 
           the Skip Page Before and Skip Page After properties should 
           be avoided, since they create HTML code inconsistent with 
           the desired effect of viewing the report horizontally, instead 
           of vertically.
      ...
      *     Acu-Report1g-PRINT-TOFILE writes the HTML file to disk
            PERFORM Acu-Report1g-PRINT-TOFILE

      *     Acu-Report1g-PRINT writes and PRINTs the HTML file
      *     PERFORM Acu-Report1g-PRINT

      *     Acu-Report1g-PREVIEW writes and PREVIEWs the HTML file
      *     PERFORM Acu-Report1g-Preview
      ...
      *{Bench}Report1g-masterprintpara
       Acu-RPT-Report1g-MASTER-PRINT-LOOP.
      *{Bench}end
      *
           PERFORM Before-Master-Print-Loop.
           PERFORM UNTIL NOT Valid-Salesdata
             PERFORM Acu-RPT-Report1g-DO-PRINT-RTN
